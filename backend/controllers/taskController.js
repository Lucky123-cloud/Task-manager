...
const updateTaskStatus = async (req, res) => {
    try {
        ...
        const isAssigned = task.assignedTo.some(
            (userId) => userId.toString() === req.user._ud.toString()
        );
...
const getDashboardData = async (req, res) => {
    try {
        ...
        //ensure all possibel statuses are included
        ...
        taskDistribution["All"] = totalTasks; //all total count to taskDistribution
...
const getUserDashboardData = async (req, res) => {
    try {
        const userId = req.user._id //only fetches the data for a logged in user
