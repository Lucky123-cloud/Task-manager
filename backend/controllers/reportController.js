...
const exportTasksReport = async (req, res) => {
    try {
        ...
        const worksheet = workbooks.addWorksheet("Tasks Report");
        ...
        res.setHeader (
            "Content-Type",
            "application/vnd.openxmlformats-officialdocument.spreadsheetml.sheet"
        );
        res.setHeader (
            "Content-Disposition",
        ...
        return workbooks.xlsx.write(res).then(() => {
            res.send();
        });
    } catch (error) {
        res
